...
$__messages = array (
	...
	'手机号错误' => 'غلط فون نمبر',
	'邮箱错误' => 'ای میل کی خرابی۔',
	'逾期未操作' => 'زائد المیعاد',
	'银行账号错误' => 'غلط بینک اکاؤنٹ',
	'账户异常' => 'اکاؤنٹ استثناء',
	'提现成功' => 'آپ نے جو $%money% نکالا ہے وہ موصول ہو گیا ہے، براہ کرم چیک پر توجہ دیں۔',
	'提现失败' => 'آپ کی واپسی کی درخواست %reason% کی وجہ سے مسترد کر دی گئی، براہ کرم کسٹمر سروس سے رابطہ کریں۔',
