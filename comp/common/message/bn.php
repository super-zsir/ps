...
$__messages = array (
	...
	'邮箱错误' => 'ইমেল ত্রুটি',
	'逾期未操作' => 'ওভারডিউ',
	'银行账号错误' => 'ভুল ব্যাংক অ্যাকাউন্ট',
	'系统通知' => 'সিস্টেম বিজ্ঞপ্তি',
	'账户异常' => 'অ্যাকাউন্ট ব্যতিক্রম',
	...
	'提现失败' => 'আপনার প্রত্যাহারের অনুরোধ %reason% এর কারণে প্রত্যাখ্যান করা হয়েছে, অনুগ্রহ করে গ্রাহক পরিষেবার সাথে যোগাযোগ করুন',
    'JOIN_BROKER' =>'%s (ID:%d) এজেন্সিতে যোগদান করেছে',
    "您已完成转会，加入公会%s，详情可至Me页面“我的公会”查看" =>"আপনাকে নতুন এজেন্সি %s-এ স্থানান্তর করা হয়েছে। আরও বিশদ বিবরণ জানতে মি পেজ চেক করতে পারেন-【আমার  এজেন্সি】",

	'恭喜您获得自选靓号资格，请在%s天内进行使用' => 'নিজে-নির্বাচিত বিশেষ আইডির সুযোগ পাওয়ার জন্য অভিনন্দন, অনুগ্রহ করে %s দিনের মধ্যে এটি ব্যবহার করুন.',
    '您序号为%s的自选靓号资格已经到期无法使用' => "সিরিয়াল আইডি %s সহ আপনার নিজে-নির্বাচিত বিশেষ আইডি সুযোগের মেয়াদ শেষ হয়ে গেছে এবং ব্যবহার করা যাবে না.",
    '您序号为%s的自选靓号资格使用有效期已经更新，请注意查看' => "সিরিয়াল আইডি %s সহ আপনার নিজে-নির্বাচিত বিশেষ আইডি সুযোগের বৈধ দিনগুলি আপডেট করা হয়েছে, অনুগ্রহ করে চেক করুন.",
);
