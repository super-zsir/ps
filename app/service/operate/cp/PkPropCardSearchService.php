...
class PkPropCardSearchService
{
    ...
    {
        $pageSize = array_get($params, 'limit', 15);
    ...
    public function recover(array $params): array
    {
        ...
        return [$res, $res ? ['after_json' => $data] : $msg];
    }
    ...
    {
        $conditions = [
            ['u.prop_card_type', 'IN', [XsPropCardConfig::TYPE_PK_PROP_CARD_ADD, XsPropCardConfig::TYPE_PK_PROP_CARD_MAG]],
        ];
