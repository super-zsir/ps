...
namespace Imee\Export\Operate\Play\Greedy;
        ...
        return Excel::export()
            ->chunk(function (int $page) use ($filterParams, $service, $bigAreaList, $engine) {
                ...
                foreach ($data['data'] as &$value) {
                    $value['engine_id'] = $engine[$value['engine_id']] ?? '';
