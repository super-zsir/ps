    ...
    public static function export($filePathName, $filterParams): bool
    {
        ...
        return Excel::export()
            ->chunk(function (int $page) use ($filterParams, $service) {
                ...
                $data = $service->getUserList(['page' => $page, 'limit' => $pageSize] + $filterParams);
