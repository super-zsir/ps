...
class IssuedwealthlvhideprivilegeController extends BaseController
{
    use ImportTrait;
    ...
    /**
     * @page issuedwealthlvhideprivilege
     * @name 财富等级隐藏权益
     */
     ...
     * @page issuedwealthlvhideprivilege
     * @point 创建
     * @logRecord(content = '创建', action = '0', model = 'issuedwealthlvhideprivilege', model_id = 'id')
     */
