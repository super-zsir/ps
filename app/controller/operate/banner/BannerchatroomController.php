...
class BannerchatroomController extends BaseController
{
     ...
     * @page  bannerchatroom
     * @point 创建
     * @logRecord(content = '创建', action = '0', model = 'bannerchatroom', model_id = 'id')
     */
     ...
     * @page  bannerchatroom
     * @point 修改
     * @logRecord(content = '修改', action = '1', model = 'bannerchatroom', model_id = 'id')
     */
