...
class RewardsendwhitelistController extends BaseController
{
    /**
    ...
    public function onConstruct()
    {
        ...
        $this->params['type'] = XsstRewardWhitelist::TYPE_REWARD_SEND;
    }
    
    /**
     * @page rewardsendwhitelist
     * @name 奖励发放白名单
     */
     ...
     * @page rewardsendwhitelist
     * @point 创建
     * @logRecord(content = '创建', action = '0', model = 'rewardsendwhitelist', model_id = 'id')
     */
     ...
     * @page rewardsendwhitelist
     * @point 删除
     * @logRecord(content = '删除', action = '2', model = 'rewardsendwhitelist', model_id = 'id')
     */
