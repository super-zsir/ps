...
use Imee\Service\Operate\Play\Greedy\BoxParamsService;

class GreedyboxparamsController extends BaseController
{
    /** @var BoxParamsService $service */
    private $service;

    protected function onConstruct()
    {
        parent::onConstruct();
        $this->service = new BoxParamsService();
    }

    /**
     * @page greedyboxparams
     * @name 玩法管理-GreedyStar玩法配置-GreedyStar 宝箱参数配置
     */
     ...
     * @page greedyboxparams
     * @point 修改
     * @logRecord(content = '修改', action = '1', model = 'greedyboxparams', model_id = 'id')
     */
