...
class GreedybrutalregionswitchController extends BaseController
{
    ...
    protected function onConstruct()
    {
        ...
        $this->service = new KvBaseService(
            GetKvConstant::KEY_GREEDY_BRUTAL_BIG_AREA_SWITCH,
            GetKvConstant::BUSINESS_TYPE_GREEDY_BRUTAL,
            GetKvConstant::INDEX_BIG_AREA_LIST,
            'greedybrutalregionswitch'
        );
    }

    /**
     * @page greedybrutalregionswitch
     * @name Greedybrutal Region
     */
     ...
     * @page  greedybrutalregionswitch
     * @point 修改
     * @logRecord(content = "修改greedybrutal大区开关", action = "1", model = "greedybrutalregionswitch", model_id = "big_area_id")
     */
