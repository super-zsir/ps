...
class HorsetotalController extends BaseController
{
    /**
    ...
    public function onConstruct()
    {
        ...
        $this->params['game_id'] = XsUidGameBlackList::HORSE_RACE_BLACKLIST;
    }
     ...
     * @page horsetotal
     * @point 创建
     * @logRecord(content = '创建', action = '0', model = 'horsetotal', model_id = 'id')
     */
     ...
     * @page horsetotal
     * @point 修改
     * @logRecord(content = '修改', action = '1', model = 'horsetotal', model_id = 'id')
     */
