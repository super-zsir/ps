...
class SweetcandylevelfirstchargeController extends BaseController
{
    /**
     * @var KvBaseService
     */
    ...
    /**
     * @page sweetcandylevelfirstcharge
     * @name Sweetcandy Level&First Charge
     */
    ...
    public function listAction()
    {
        $c = $this->params['c'] ?? '';
        if ($c == 'switch') {
            $data = $this->levelService->getFirstChargeSwitch(XsGlobalConfig::GAME_CENTER_ID_SWEET_CANDY);
     ...
     * @page sweetcandylevelfirstcharge
     * @point 修改
     * @logRecord(content = '修改', action = '1', model = 'sweetcandylevel', model_id = 'big_area_id')
     */
     ...
     * @page sweetcandylevelfirstcharge
     * @point 修改首冲开关
     * @logRecord(content = '修改首冲开关', action = '1', model = 'sweetcandyfirstcharge', model_id = 'game_center_id')
     */
    public function modifySwitchAction()
    {
        $this->params['game_center_id'] = XsGlobalConfig::GAME_CENTER_ID_SWEET_CANDY;
