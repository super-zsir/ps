...
class TarotregionswitchController extends BaseController
{
    ...
    protected function onConstruct()
    {
        ...
        $this->service = new KvBaseService(
            GetKvConstant::KEY_TAROT_BIG_AREA_SWITCH,
     ...
     * @page  tarotregionswitch
     * @point 修改
     * @logRecord(content = "修改tarot大区开关", action = "1", model = "tarotregionswitch", model_id = "big_area_id")
     */
