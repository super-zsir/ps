...
class ActivityTaskGamePlayMultiwireValidation extends Validator
{
    protected function rules(): array
    {
        return [
            ...
            'vision_content_json.header_img_vc'            => 'required_if:has_be_related,0|string',
            'vision_content_json.title_bottom_img_vc'      => 'required_if:has_be_related,1|string',
        ];
    }
    ...
    protected function attributes(): array
    {
        return [
            ...
            'vision_content_json.header_img_vc'            => '头图',
            'vision_content_json.title_bottom_img_vc'      => '主标题底框',
        ];
    }
